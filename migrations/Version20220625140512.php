 ...
 */
final class Version20220625140512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE value value VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE value value VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
